        ...
        <>
            <div className='p-2 md:p-5 bg-white dark:bg-zinc-700 shadow-normal rounded-2xl'>
                <NavLink className="relative mb-2 md:mb-5" to={`/products/${pro.shortName}`}>
                    {
                        (pro.cover) ? (
                            <img loading='lazy' className="w-auto mx-auto md:w-auto h-auto mb-6 object-contain" src={`${DataUrl}/courses/covers/${pro.cover}`} alt="" />
                        ) : (
                            <img loading='lazy' className="w-auto mx-auto md:w-auto h-auto mb-6 object-contain" src="/images/blogs/nocover.png" alt="" />
                        )
                    }
                    {
                        (pro.discount) ? (
